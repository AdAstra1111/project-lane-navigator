...
export function RepairStrategyPanel({ projectId }: Props) {
  const { prp1, nrf1, prp2, roi, prp2s, rcc, isLoading, nrf1Loading, prp2Loading, roiLoading, prp2sLoading, rccLoading, error, refresh } = usePreventiveRepairPrioritization(projectId);
