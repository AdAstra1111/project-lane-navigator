...
import { Zap, Film, HardHat, DollarSign, TrendingUp } from 'lucide-react';
...
export function StateGraphOverview({ stateGraph }: Props) {
  const { creative_state: c, execution_state: e, production_state: p, finance_state: f, revenue_state: r } = stateGraph;

  const layers = [
    {
      title: 'Creative', icon: Film, color: 'bg-amber-500',
      metrics: [
    ...
    {
      title: 'Execution', icon: Zap, color: 'bg-sky-500',
      metrics: [
    ...
    {
      title: 'Production', icon: HardHat, color: 'bg-emerald-500',
      metrics: [
    ...
    {
      title: 'Finance', icon: DollarSign, color: 'bg-violet-500',
      metrics: [
    ...
    {
      title: 'Revenue', icon: TrendingUp, color: 'bg-rose-500',
      metrics: [
