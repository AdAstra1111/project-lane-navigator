  ...
  return (
    <SectionShell id="cinematic-intro" className="bg-[hsl(225,20%,4%)]">
      <div className="flex flex-col items-center text-center gap-8">
        ...
        <div className="hidden sm:block relative w-full max-w-lg h-[320px] mt-8">
          {/* Central node */}
          <motion.div
        ...
        {/* ── Mobile: center node + grid ── */}
        <div className="sm:hidden flex flex-col items-center gap-6 mt-4 w-full">
          {/* Central node */}
          <motion.div
            initial={{ scale: 0, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
