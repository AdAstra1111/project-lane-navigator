...
export const PRODUCTION_TYPE_RULES: Record<ProjectFormat, ProductionTypeRule> = {
  ...
  'hybrid-documentary': {
    ...
    label: 'Hybrid Documentary',
    emoji: '🎭',
    allowedConcepts: [
      'grants', 'broadcaster-pre-sales', 'ngo-partners', 'impact-investors',
      'impact-campaign', 'archive-clearance', 'subject-access', 'editorial-independence',
      'festival-circuit', 'educational-distribution', 'rights-clearance',
      'broadcaster-commission', 'streamer-acquisition', 'arts-council',
      'animation-integration', 'reconstruction', 'scripted-elements', 'essay-film',
    ],
    disallowedConcepts: [
      'cast-packaging', 'talent-tier', 'minimum-guarantee', 'recoupment-waterfall',
      'equity-financing', 'gap-finance', 'client-budget', 'agency-commission',
      'subscriber-model', 'episode-scalability', 'influencer-leverage',
    ],
    financingModel: ['Grants', 'Arts Council', 'Broadcaster Pre-Sales', 'Co-Pro', 'Impact Investors', 'Innovation Funds'],
    stakeholderTemplate: ['Director', 'Producer', 'Subject/Access', 'Animator/VFX', 'Broadcaster', 'Sales Agent', 'Impact Partner'],
    deliverablesTemplate: ['Feature Master', 'M&E', 'Animation Assets', 'Impact Toolkit', 'Educational Guide', 'Key Art', 'Trailer'],
    ...
    marketStrategyFocus: ['Arts council applications', 'Festival strategy (IDFA, Sheffield, Sundance)', 'Innovation fund pitching', 'Impact campaign design', 'Broadcaster pitching'],
    dashboardSummaryLabel: 'Hybrid Documentary Intelligence',
  },
  commercial: {
    type: 'commercial',
  ...
  'limited-series': {
    ...
    emoji: '🎭',
    allowedConcepts: [
      'platform-deal', 'broadcaster-commission', 'co-production', 'equity',
      'cast-packaging', 'showrunner', 'pilot', 'season-arc', 'awards-campaign',
      'festival-premiere', 'streaming-deal', 'territory-rights', 'prestige-positioning',
    ],
    disallowedConcepts: [
      'renewal-probability', 'episode-scalability', 'multi-season',
      'client-budget', 'agency-commission', 'brand-integration',
      'subscriber-model', 'influencer-leverage', 'ad-revenue',
    ],
    financingModel: ['Platform Deal', 'Broadcaster', 'Co-Pro', 'Incentives', 'Equity', 'Other'],
    stakeholderTemplate: ['Showrunner', 'Producer', 'Director', 'Writer', 'Cast', 'Platform Buyer', 'Sales Agent'],
    deliverablesTemplate: ['Episode Masters', 'M&E per Episode', 'Trailer', 'Key Art', 'Press Kit', 'Screeners'],
    ...
    dashboardSummaryLabel: 'Limited Series Intelligence',
  },
  'anim-feature': {
    type: 'anim-feature',
    ...
    emoji: '🎨',
    allowedConcepts: [
      'pre-sales', 'equity', 'co-production', 'tax-credit', 'gap-finance',
      'voice-cast', 'franchise-potential', 'merchandise', 'theme-park',
      'streaming-deal', 'theatrical-release', 'territory-rights', 'ip-ownership',
    ],
    disallowedConcepts: [
      'client-budget', 'agency-commission', 'brand-integration',
      'subscriber-model', 'influencer-leverage', 'ad-revenue',
      'live-action-cast', 'location-shooting',
    ],
    financingModel: ['Studio Deal', 'Pre-Sales', 'Co-Pro', 'Incentives', 'Equity', 'Other'],
    stakeholderTemplate: ['Director', 'Producer', 'Writer', 'Voice Cast', 'Animation Studio', 'Sales Agent', 'Distributor'],
    deliverablesTemplate: ['DCP', 'ProRes Master', 'M&E', 'Subtitles', 'Key Art', 'Trailer', 'Making-Of'],
    ...
    marketStrategyFocus: ['IP franchise development', 'Merchandise licensing', 'International pre-sales', 'Platform/theatrical strategy', 'Voice cast packaging'],
    dashboardSummaryLabel: 'Animated Feature Intelligence',
  },
  'anim-series': {
    type: 'anim-series',
    ...
    emoji: '📺',
    allowedConcepts: [
      'platform-deal', 'broadcaster-commission', 'co-production', 'licensing',
      'merchandise', 'toy-deal', 'format-rights', 'multi-season', 'renewal-probability',
      'episode-budget', 'per-episode-cost', 'territory-rights',
    ],
    disallowedConcepts: [
      'theatrical-release', 'p&a', 'festival-premiere', 'awards-campaign',
      'client-budget', 'agency-commission', 'live-action-cast',
    ],
    financingModel: ['Platform Deal', 'Broadcaster', 'Licensing Pre-Sales', 'Co-Pro', 'Incentives', 'Other'],
    stakeholderTemplate: ['Showrunner', 'Producer', 'Director', 'Writer', 'Animation Studio', 'Platform Buyer', 'Licensing Agent'],
    deliverablesTemplate: ['Series Bible', 'Episode Masters', 'M&E per Episode', 'Style Guide', 'Licensing Package'],
    ...
    marketStrategyFocus: ['Platform pitching', 'Licensing partnerships', 'Toy/merch development', 'International format sales', 'Multi-season planning'],
    dashboardSummaryLabel: 'Animated Series Intelligence',
  },
  reality: {
    type: 'reality',
    ...
    emoji: '📡',
    allowedConcepts: [
      'format-rights', 'commission', 'broadcaster-deal', 'platform-deal',
      'sponsorship', 'brand-integration', 'casting-scalability', 'repeatability',
      'international-format-sales', 'cost-per-episode', 'studio-audience',
    ],
    disallowedConcepts: [
      'script-coverage', 'screenplay', 'cast-packaging', 'pre-sales',
      'equity', 'gap-finance', 'recoupment-waterfall', 'festival-premiere',
      'awards-campaign', 'sales-agent', 'minimum-guarantee',
    ],
    financingModel: ['Commission Fee', 'Broadcaster', 'Platform Deal', 'Sponsorship', 'Format Sales', 'Other'],
    stakeholderTemplate: ['Format Creator', 'Producer', 'Director', 'Casting Producer', 'Commissioner', 'Format Distributor', 'Sponsor'],
    deliverablesTemplate: ['Format Bible', 'Episode Masters', 'Sizzle Reel', 'Casting Package', 'Format Sales Kit'],
    ...
    marketStrategyFocus: ['Format development', 'Commissioner pitching', 'International format sales', 'Sponsorship development', 'Casting strategy'],
    dashboardSummaryLabel: 'Reality Format Intelligence',
  },
  'podcast-ip': {
    type: 'podcast-ip',
    label: 'Podcast IP',
    emoji: '🎙️',
    allowedConcepts: [
      'ad-revenue', 'sponsorship', 'premium-subscriptions', 'adaptation-option',
      'brand-integration', 'audience-growth', 'cross-media', 'ip-ownership',
      'book-deal', 'tv-adaptation', 'film-adaptation', 'live-events',
    ],
    disallowedConcepts: [
      'theatrical-release', 'p&a', 'festival-premiere', 'dcp',
      'sales-agent', 'minimum-guarantee', 'recoupment-waterfall',
      'co-production', 'gap-finance', 'tax-credit',
    ],
    financingModel: ['Ad Revenue', 'Sponsorship', 'Premium Subscriptions', 'Adaptation Option', 'Brand Integration', 'Other'],
    stakeholderTemplate: ['Host/Creator', 'Producer', 'Editor', 'Distributor', 'Ad Sales', 'Adaptation Agent', 'Brand Partner'],
    deliverablesTemplate: ['Episode Audio', 'Show Notes', 'Social Clips', 'Transcript', 'Brand Integration Report', 'Adaptation Bible'],
    ...
    marketStrategyFocus: ['Audience growth strategy', 'Ad sales optimization', 'Adaptation development', 'Brand partnership', 'Live event expansion'],
    dashboardSummaryLabel: 'Podcast IP Intelligence',
  },
};
