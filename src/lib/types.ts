export type ProjectFormat = 'film' | 'tv-series' | 'short-film' | 'documentary' | 'documentary-series' | 'digital-series' | 'commercial' | 'branded-content' | 'music-video' | 'proof-of-concept' | 'hybrid';
