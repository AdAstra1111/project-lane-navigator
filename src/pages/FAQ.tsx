...
const faqs = [
  ...
  { cat: 'core', q: 'What does IFFY stand for?', a: 'Intelligent Film Flow & Yield — IFFY is a project intelligence system that guides film and TV projects from inception through production to monetisation and beyond.' },
