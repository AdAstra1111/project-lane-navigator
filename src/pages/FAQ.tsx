...
const faqs = [
  ...
  { cat: 'core', q: 'What does IFFY stand for?', a: 'Intelligent Film Flow & Yield — IFFY is a project intelligence system that guides film and TV projects through six lifecycle stages, from Development through Sales & Delivery.' },
  { cat: 'core', q: 'What are the six lifecycle stages?', a: 'Development, Packaging, Pre-Production, Production, Post-Production, and Sales & Delivery. Each stage has its own readiness score, intelligence panel, and risk assessment. Stages unlock when the prior stage hits a readiness threshold — or the producer can override.' },
  { cat: 'readiness', q: 'What is a "readiness score"?', a: 'Each lifecycle stage has its own 0–100 readiness score measuring stage-specific criteria. Development scores script quality and audience clarity. Packaging scores cast strength and director attachment. Pre-Production scores budget completeness and schedule readiness. These six scores roll up into a Master Viability Score.' },
  { cat: 'readiness', q: 'What is the Master Viability Score?', a: 'A weighted composite of all six stage readiness scores. Weights adjust dynamically by production type — a studio feature weights Packaging higher, while a documentary weights Development and Sales more heavily.' },
  { cat: 'readiness', q: 'How does IFFY decide my "best next step"?', a: 'It identifies the weakest dimension of your current stage\'s readiness score and recommends the single action most likely to improve it. If you have no director attached in Packaging, that\'s more impactful than tweaking a finance scenario. IFFY prioritises accordingly.' },
  ...
  { cat: 'readiness', q: 'Can I use IFFY early in development?', a: 'Yes — that\'s the ideal time. IFFY is designed for every stage from early Development onwards. The earlier you understand your finance pathway, the better your creative and packaging decisions will be.' },
  ...
  { cat: 'pipeline', q: 'What is the lifecycle sidebar?', a: 'The lifecycle sidebar is a vertical navigation that guides your project through six stages: Development, Packaging, Pre-Production, Production, Post-Production, and Sales & Delivery. Each stage shows its readiness score, status badge, and risk colour coding.' },
  { cat: 'pipeline', q: 'What are stage gates?', a: 'Stage gates are automated rules that determine when a project is ready to advance to the next lifecycle stage. For example, moving from Development to Packaging requires script clarity, and moving to Pre-Production requires confirmed attachments. Producers can override gates when needed.' },
  ...
  { cat: 'trends', q: 'What are "trend signals"?', a: 'Trend signals are patterns detected across multiple independent sources — buyer appetite shifts, genre cycles, cast momentum, and market behaviours. IFFY requires signals to appear across three or more sources before surfacing them. They\'re matched to your project automatically and adapt to your current lifecycle stage.' },
  { cat: 'trends', q: 'How are trends stage-aware?', a: 'IFFY prioritises different intelligence layers depending on your project\'s current stage. In Development, narrative and genre trends dominate. In Packaging, talent heat and buyer appetite take priority. In Sales & Delivery, platform demand and territory pricing are emphasised. Staleness thresholds also tighten as you move closer to market.' },
