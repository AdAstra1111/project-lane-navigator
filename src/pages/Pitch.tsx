      ...
      <section style={{ padding: '6rem 2rem', background: bgCardAlt }} className="print:py-12 print:break-before-page">
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.25rem' }}>
            {capability('🧠', 'Narrative Intelligence', 'Analyses story structure in real time — arc logic, character pressure, dramatic tension. Every document is scored against two proprietary metrics: CI (Creative Integrity — narrative and creative soundness) and GP (Greenlight Probability — commercial viability). Identifies gaps and risks before they cost money.')}
            ...
            {capability('📊', 'Greenlight Intelligence', 'Two proprietary scores on every project: Creative Integrity (CI) — how narratively and creatively sound the material is — and Greenlight Probability (GP) — the likelihood of commercial success based on format, market, and structural criteria. Know before you commit.')}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.25rem', marginBottom: '2rem' }}>
          {[
            ...
            },
            {
              ...
              body: 'Creative Integrity (CI) and Greenlight Probability (GP) are not off-the-shelf metrics. They are IFFY-native models trained on narrative structure, format rules, and market criteria — producing scores no other system can replicate.',
            },
            {
              icon: '🔗',
