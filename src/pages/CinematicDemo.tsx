...
const scenes = [
  {
    ...
    phase: 'intro',
    bg: heroBoardroom,
    preTitle: 'THE FUTURE OF FILM FINANCE',
  ...
  },
  {
    ...
    title: 'Film finance is broken.',
    body: 'Producers spend 60% of development time on admin — not storytelling. Deal structures live in email. Market intelligence arrives too late.',
  ...
  },
  {
    ...
    body: 'Incentives, co-productions, pre-sales, equity, gap — all evaluated in context. Change one variable, watch the whole picture adapt.',
  ...
  },
  {
    ...
    body: 'Trend signals, cast momentum, genre cycles, buyer appetite — matched to your specific project. Not generic reports. Your intelligence.',
  ...
  },
  {
    ...
    body: 'A single score that tells you exactly where your project stands — and the one action that will move the needle most.',
    stat: { value: '1', label: 'next best action, always' },
  },
  {
    id: 'ecosystem',
    phase: 'stats',
    ...
    stats: [
      ...
      { icon: Shield, value: '∞', label: 'Co-pro scenarios' },
