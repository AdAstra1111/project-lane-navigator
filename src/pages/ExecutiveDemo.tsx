...
import {
  ...
  Film, ShoppingCart, TrendingUp, Users, Shield, Globe, Gauge,
  AlertTriangle, CheckCircle2, BarChart3, Star, Zap, Target,
  FileText, Eye, Award, Tv, PieChart, Wallet, ChevronRight,
} from 'lucide-react';
  ...
  return (
    <div className="relative min-h-full flex items-center justify-center">
      ...
      <div className="relative z-10 text-center space-y-8 px-6 max-w-3xl">
        ...
        >
          {['Prestige Action Thriller', '$165M', '2h 18m', 'Global Theatrical'].map((tag, i) => (
...
/* ═══════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════ */
function StageHeader({ icon: Icon, stage, title, subtitle }: {
  icon: React.ElementType; stage: string; title: string; subtitle?: string;
}) {
  return (
    <div className="mb-6">
      <motion.div
...
function DevelopmentStage() {
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-8 py-8 space-y-6">
      <StageHeader icon={Lightbulb} stage="Stage 1" title="Development" subtitle="Creative and commercial validation" />
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 h-2 rounded-full bg-white/10 overflow-hidden">
                <motion.div className="h-full rounded-full bg-emerald-500" initial={{ width: 0 }} animate={{ width: '92%' }} transition={{ delay: 0.8, duration: 1 }} />
              </div>
      ...
      <DataCard delay={0.5}>
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          {[
            ...
            <motion.div key={item.label} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 + i * 0.1 }} className="space-y-1">
      ...
      <DataCard delay={0.6}>
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-display font-bold text-amber-400"><AnimatedCounter value={61} suffix="%" /></span>
          </div>
        </div>
        <p className="text-xs text-white/40">Concept strong but requires bankable cast and studio commitment to advance.</p>
        <div className="mt-3 space-y-2">
          <ScoreBar label="Script Quality" value={88} delay={0.8} color="bg-emerald-500" />
          <ScoreBar label="Concept Clarity" value={92} delay={0.9} color="bg-emerald-500" />
          <ScoreBar label="Cast Attachment" value={0} delay={1.0} color="bg-red-500" />
          <ScoreBar label="Studio Interest" value={35} delay={1.1} color="bg-amber-500" />
        </div>
      </DataCard>
    </div>
  );
...
function PackagingStage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-8 py-8 space-y-6">
      <StageHeader icon={Package} stage="Stage 2" title="Packaging" subtitle="Attaching elements that unlock financing" />

      {attachments.map((att, i) => (
        <DataCard key={att.role} delay={0.3 + i * 0.2}>
            ...
            <div className="sm:w-48 space-y-2">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-2xl font-display font-bold text-primary">
                  <AnimatedCounter value={att.scoreAfter} suffix="%" />
                </span>
              </div>
...
function FinancingStage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-8 py-8 space-y-6">
      <StageHeader icon={DollarSign} stage="Stage 3" title="Financing Structure" subtitle="Capital stack and risk assessment" />
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        {[
          ...
          <DataCard key={item.label} delay={0.3 + i * 0.1}>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <DataCard delay={0.9}>
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <span className="text-lg font-display font-bold text-emerald-400 ml-auto"><AnimatedCounter value={97} suffix="%" /></span>
          </div>
        </DataCard>
      </div>
    </div>
...
function ProductionStage() {
  const risks = [
    { label: 'VFX Overages', status: 'warning', detail: 'Projected +4% above estimate', severity: 'Medium' },
    { label: 'Weather Delay', status: 'caution', detail: 'Probability moderate for Iceland exteriors', severity: 'Low' },
    { label: 'Third Unit Overspend', status: 'alert', detail: 'Second unit aerial work exceeding allocation', severity: 'Medium' },
  ];

  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-8 py-8 space-y-6">
      <StageHeader icon={Clapperboard} stage="Stage 4" title="Production Intelligence" subtitle="Live monitoring and risk management" />
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <DataCard delay={0.5}>
          ...
          <div className="space-y-3">
            <ScoreBar label="Schedule Completion" value={87} delay={0.6} color="bg-emerald-500" />
            <ScoreBar label="VFX Pipeline" value={62} delay={0.7} color="bg-amber-500" />
            <ScoreBar label="Post-Production Prep" value={34} delay={0.8} color="bg-sky-500" />
            <ScoreBar label="Deliverables Readiness" value={18} delay={0.9} color="bg-violet-500" />
          </div>
        </DataCard>
...
function PostStage() {
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-8 py-8 space-y-6">
      <StageHeader icon={Film} stage="Stage 5" title="Post-Production & Positioning" subtitle="Festival strategy, awards, and audience analysis" />
        ...
        <DataCard delay={0.3}>
          ...
          <div className="space-y-3">
            {[
              ...
              <motion.div key={f.festival} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 + i * 0.15 }} className="flex items-center justify-between py-2 border-b border-white/[0.04] last:border-0">
                <div>
        ...
        <DataCard delay={0.4}>
          ...
          <div className="space-y-3">
            {[
              ...
              <motion.div key={a.category} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6 + i * 0.1 }} className="flex items-center justify-between">
                <div>
      ...
      <DataCard delay={0.6}>
        ...
        <div className="grid grid-cols-2 gap-4">
          {[
            ...
            <motion.div key={q.quad} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 + i * 0.1 }}>
              <ScoreBar label={q.quad} value={q.strength} delay={0.9 + i * 0.1} color={q.strength >= 80 ? 'bg-emerald-500' : q.strength >= 60 ? 'bg-primary' : 'bg-amber-500'} />
            </motion.div>
          ))}
        </div>
...
function ReleaseStage() {
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-8 py-8 space-y-6">
      <StageHeader icon={Globe} stage="Stage 6" title="Global Release Simulation" subtitle="Revenue projections across all windows" />

      <DataCard delay={0.3}>
        <h4 className="text-xs font-display uppercase tracking-wider text-primary/60 mb-4">Box Office Projections</h4>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            { territory: 'Domestic', value: 410 },
            { territory: 'International', value: 680 },
            { territory: 'China', value: 120 },
            { territory: 'Total B.O.', value: 1210, highlight: true },
          ].map((t, i) => (
            <motion.div
              key={t.territory}
            ...
            >
              ...
              <p className={`text-2xl sm:text-3xl font-display font-bold ${t.highlight ? 'text-primary' : 'text-white/80'}`}>
                $<AnimatedCounter value={t.value} />M
              </p>
            </motion.div>
          ))}
        </div>
      ...
      <DataCard delay={0.5}>
        ...
        <div className="space-y-3">
          {[
            ...
            <motion.div key={r.label} initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.7 + i * 0.1 }}>
              <div className="flex items-center justify-between text-sm mb-1">
                <span className="text-white/60">{r.label}</span>
                <span className="font-mono text-white/70">${r.value}M</span>
              </div>
              <div className="h-1.5 rounded-full bg-white/10 overflow-hidden">
                <motion.div className="h-full rounded-full bg-sky-500" initial={{ width: 0 }} animate={{ width: `${r.pct}%` }} transition={{ delay: 0.9 + i * 0.1, duration: 0.6 }} />
              </div>
            </motion.div>
          ))}
        </div>
      ...
      <DataCard delay={0.7} className="text-center">
        ...
        <p className="text-5xl sm:text-6xl font-display font-bold text-primary">
          $<AnimatedCounter value={1620} duration={1.5} />M
        </p>
...
function RecoupmentStage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-8 py-8 space-y-6">
      <StageHeader icon={PieChart} stage="Stage 7" title="Recoupment Model" subtitle="Waterfall distribution and backend participation" />
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <DataCard delay={0.6} className="text-center">
      ...
      <DataCard delay={1.0} className="text-center border-emerald-500/20">
...
function FinalStage({ onStart }: { onStart: () => void }) {
  ...
  return (
    <div className="relative min-h-full flex items-center justify-center">
      ...
      <div className="relative z-10 text-center space-y-10 px-6 max-w-3xl py-16">
        {/* Journey steps */}
        ...
        >
          <p className="text-lg sm:text-xl text-white/50 leading-relaxed max-w-xl mx-auto">
            IFFY is not just development support.<br />
            It is a command system for global filmmaking.<br />
            From first draft to billion-dollar release.
          </p>
          <p className="text-xs font-display uppercase tracking-[0.3em] text-primary/60">
