...
const LANE_OVERRIDES: Record<ProductLane, Partial<CinematicThresholds>> = {
  ...
  independent_film: {
    ...
    min_arc_mid_energy: 0.40,
    min_arc_end_energy: 0.65,
    min_contrast: 0.40,
    min_slope: 0.005,
    energy_drop_threshold: 0.20,
    penalty_tonal_whiplash: 0.04,
    penalty_direction_reversal: 0.03,
    penalty_weak_arc: 0.05,
    penalty_pacing_mismatch: 0.03,
    penalty_energy_drop: 0.04,
    penalty_no_escalation: 0.08,
    penalty_low_contrast: 0.05,
  },
