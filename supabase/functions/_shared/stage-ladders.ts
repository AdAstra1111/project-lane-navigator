...
export const STAGE_LADDERS = {
  FORMAT_LADDERS: {
    ...
    "anim-series":        ["idea","concept_brief","market_sheet","treatment","story_outline","character_bible","beat_sheet","episode_beats","episode_script","season_master_script","production_draft"],
    "reality":            ["idea","concept_brief","market_sheet","treatment","beat_sheet","episode_beats","episode_script"],
